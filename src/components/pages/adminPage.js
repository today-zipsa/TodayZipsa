...
//필수입력 표시 *
const requireEl = util.createEl('span', {class:'required-input'}, {textContent:'*'});

// 상품명 입력
const tr1El = util.createEl('tr');
const th1El = util.createEl('th', {textContent:'상품명'});
th1El.append(requireEl);
